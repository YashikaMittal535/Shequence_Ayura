...
const seasonsData = {
  summer: {
    ...
    foods: [" Watermelon", " Coconut", " Cucumber"],
    activities: [" Swimming", " Walk", " Pranayama"],
  },
  winter: {
    title: "Winter",
    ...
    <div className="min-h-screen bg-gradient-to-br from-cream to-primary-light/30 pb-24 px-4 py-8">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-gray-text mb-6">
          Enhance your knowledge about wellness and healthy living
        </p>
        ...
        {activeTab === "seasonal" && (
          <div className="p-6">
            ...
            <p className="text-gray-500 mb-8">
              Adjust your routine and diet according to the season
            </p>
                        ...
                        <div>
                          <button
                            onClick={() =>
                              setOpenSection((prev) => ({
                                ...prev,
                                [key + "foods"]: !prev[key + "foods"],
                              }))
                            }
                            className="w-full bg-green-50 hover:bg-green-100 text-green-700 p-2 rounded-lg font-medium"
                          >
                            🍽 Foods
                          </button>

                          <AnimatePresence>
                            {openSection[key + "foods"] && (
                              <motion.div
                        ...
                        <div>
                          <button
                            onClick={() =>
                              setOpenSection((prev) => ({
                                ...prev,
                                [key + "activities"]: !prev[key + "activities"],
                              }))
                            }
                            className="w-full bg-blue-50 hover:bg-blue-100 text-blue-700 p-2 rounded-lg font-medium"
                          >
                            🧘 Activities
                          </button>

                          <AnimatePresence>
                            {openSection[key + "activities"] && (
                              <motion.div
                                initial={{ opacity: 0, height: 0 }}
                                animate={{ opacity: 1, height: "auto" }}
                                exit={{ opacity: 0, height: 0 }}
